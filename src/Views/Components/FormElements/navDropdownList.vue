		...
		computed: {
          ...
          attributes:[
            ...
            },
            {
              type: "size",
              value: this.d_size,
              description: this.$store.state.navText.size,
              text: this.$store.state.navText.sizeText
            },
            {
              type: "multiple",
