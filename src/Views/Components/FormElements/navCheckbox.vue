        ...
        return {
          ...
          attributes:[
            ...
            },
            {
              ...
              text: "Specifies the value (boolean/array)for the &lt;checkbox-input&gt element.",
            },
            {
              type: "options",
              value: this.d_options,
            ...
            },
            {
              type: "box",
              value: this.d_box,
              description: this.$store.state.navText.box,
              text: this.$store.state.navText.boxText,
            },
            {
              type: "mask",
              value: this.d_mask,
