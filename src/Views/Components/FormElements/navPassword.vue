...
<script>
  ...
  export default {
    ...
    data() {
      const d_label= 'Password'
      const d_name= 'passwordTextField'
      const d_value= ''
      const d_pattern= /([a-zA-Z0-9](_|-| )[a-zA-Z0-9])*/
      const d_maxlength= 20
      const d_minlength= 8
      const d_placeholder= 'Jdoe123!'
		...
		computed: {
          ...
          attributes:[
            ...
            },
            {
              ...
              text: "Specifies the value for the &lt;password-input&gt element.",
            },
            {
              type: "placeholder",
