...
<script>
    ...
    export default {
        ...
        data () {
            ...
            const recipientVal= null;
            const deliveryOptionVal= null;
            const shipping= false;
            const recipientNote= null;
            const TAmaxlength= null;
            const ctx= ()=>{
                //your code goes here
            };
            const formName="samleNavForm"; 
            const form= {
                title: 'Vue Form',
                compName: 'vue-form',
