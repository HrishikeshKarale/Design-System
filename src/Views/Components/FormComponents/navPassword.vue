        ...
        data() {
            ...
            return {
                ...
                d_password: {
                    ...
                    description: '<p>The &lt;password-input&gt; tag defines a password field (characters are masked).</p>\
                                    <p><strong>Note:</strong> Any forms involving sensitive information like passwords should be served over HTTPS.</p>',
