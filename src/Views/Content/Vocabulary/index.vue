                ...
                <article id= 'vocabulary'>
                    ...
                    <section id= "C">
                        ...
                        <div
                            ...
                            class= 'subSection'
                        >
                            <h4>cart page, shopping cart, shopping cart page</h4>
                            <p>
                        ...
                        <div
                            ...
                            class= 'subSection'
                        >
                            <h4>check out (verb)</h4>
                            <ol>
                                <li>To pay for items and complete an order.</li>
                                <li>Look at, read, or review something to determine its value or usefulness.</li>
                            </ol>
                            <p>
                                Examples:
                            </p>
                            <ol>
                                <li>Customers want to see a summary of the items in their cart before they check out.</li>
                                <li>Check out these tips to improve your email marketing strategy.</li>
                            </ol>
                        </div>
                        <div
                            id= 'checkOutV'
                        ...
                        >
                            <h4>customer</h4>
                            <p>
                                A person or organization that buys goods or services from a merchant’s store or business.
                            </p>
                            <p>
                                Example: Use bulk editing to delete customers, add customer tags, and delete customer tags for several customers at once.
                            </p>
                        </div>
                    </section>
                    <hr>
                    <section id= "D">
                        <h3>D: dev store…</h3>
                        <div
                            id= 'developmentDevStore'
                            class= 'subSection'
                        >
                            <h4>development store, dev store</h4>
                            <p>
                    ...
                    <section id= "I">
                        ...
                        >
                            ...
                            <ol>
                                <li>The customer has 5 items in their cart.</li>
                                <li>Automatically fulfill items in an order.</li>
                            </ol>
                        </div>
                    </section>
                    <hr>
                    ...
                    <section id= "M">
                        ...
                        >
                            ...
                            <p>
                                Merchants use Shopify or have a Shopify account to run their business. There are many different types of Shopify merchants.
                            </p>
                            <p>
                    ...
                    <section id= "O">
                        ...
                        >
                            <h4>online store</h4>
                            <p>
                                A merchant’s ecommerce website. It’s one of many sales channels that a merchant can use to sell products and services through the Shopify platform. Other sales channels include Facebook, Pinterest, Shopify POS, and Buy Button.
                            </p>
                            <p>
                    ...
                    <section id= "P">
                        ...
                        >
                            ...
                            <p>
                                <strong>Tip:</strong> It’s fine to use this term informally.
                            </p>
                            <p>
                    ...
                    <section id= "R">
                        ...
                        >
                            ...
                            <p>
                                A customer who makes purchases from a business on more than one occasion.
                            </p>
                            <p>
                                Example: Returning customers provide useful word-of-mouth marketing.
                            </p>
                        </div>
                    </section>
                    <hr>
                    <section id= "S">
                        ...
                        <div
                            ...
                            class= 'subSection'
                        >
                            <h4>Shopify POS, Shopify point of sale</h4>
                            <p>
                                Shopify’s point of sale software that’s used on tablets and smartphones to sell in person and accept payments.
                            </p>
                            <p>
                    ...
                    <section id= "V">
                        ...
                        >
                            <h4>variant</h4>
                            <p>
                                Merchants can add variants to a product that comes in more than one option, like size or color. Each combination of options is a variant.
                            </p>
                            <p>
